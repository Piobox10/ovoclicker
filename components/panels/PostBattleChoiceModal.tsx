...
const PostBattleChoiceModal: React.FC<PostBattleChoiceModalProps> = ({
  ...
  // When this modal is open, it means we are in the choice phase.
  // It should be completely self-contained and not be closed by backdrop or Escape.
  if (!isOpen || isAwaitingTarget) {
    return null; 
  }
